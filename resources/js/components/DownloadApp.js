        ...
        <div className='tw-grid md:tw-grid-cols-12 tw-gap-1 tw-items-center tw-mt-10'>
            ...
            <div className='md:tw-col-span-7'>
                <div className='tw-mb-8'>
                    <p className='tw-text-gray-700 tw-text-2xl tw-font-semibold tw-mb-6'>Get Bee Stores from Appstore & Playstore</p>
                    ...
                    <p className='tw-text-gray-700'>
                        ...
                        <br />
                        Contact our Employee: ihlas@beeonline.xyz
                    </p>
                </div>
                <div className='tw-flex tw-justify-around tw-items-center'>
                    <div className='tw-mb-2'>
                        <a href="https://play.google.com/store" target={'_blank'}>
                            <img src="/images/playstore.png" alt="Download App on Playstore" className='tw-w-100 tw-h-16 sm:tw-w-60 sm:tw-h-20 mx-auto' title='Download App on Playstore' />
                        </a>
                    </div>
                    <div className='tw-mb-2'>
                        <a href="https://www.apple.com/app-store/" target={'_blank'}>
                            <img src="/images/appstore.png" alt="Download App on Appstore" className='tw-w-100 tw-h-16 sm:tw-w-60 sm:tw-h-20 mx-auto' title='Download App on Appstore' />
                        </a>
                    </div>
                </div>
            </div>
