...
export default function Footer() {
    return (
        <div className="footer tw-mt-10 tw-bg-gray-300 tw-items-center">
            <div className="tw-grid tw-grid-cols-12">
                <div className="tw-col-span-12 sm:tw-col-span-6 md:tw-col-span-6 lg:tw-col-span-4 tw-px-10 tw-py-8 md:tw-py-10 md:tw-mx-auto">
                    <p className="tw-text-xl md:tw-text-xl tw-font-semibold tw-text-yellow-500 tw-pb-4">What is E-BEE?</p>
                ...
                <div className="tw-col-span-12 sm:tw-col-span-6 md:tw-col-span-6 lg:tw-col-span-3 tw-pb-8 tw-px-10 md:tw-px-10 sm:tw-py-10 lg:tw-mx-auto">
                    <p className="tw-text-xl md:tw-text-xl tw-font-semibold tw-text-yellow-500 tw-pb-4">MORE INFO</p>
                    <ul>
                ...
                <div className="tw-col-span-12 sm:tw-col-span-6 md:tw-col-span-6 lg:tw-col-span-2 md:tw-ml-10 tw-px-10 tw-pb-8 md:tw-px-0 lg:tw-py-10 lg:tw-mx-auto">
                    <p className="tw-text-xl md:tw-text-xl tw-font-semibold tw-text-yellow-500 tw-pb-4">YOUR DATA</p>
                    <ul>
                ...
                <div className="tw-col-span-12 sm:tw-col-span-6 md:tw-col-span-6 lg:tw-col-span-3 tw-px-10 md:tw-px-10 lg:tw-py-10 lg:tw-mx-auto">
                    <p className="tw-text-xl md:tw-text-xl tw-font-semibold tw-text-yellow-500 tw-pb-4">CONTACT US</p>
                    <ul>
