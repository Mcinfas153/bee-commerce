...
export default function Footer() {
    return (
        <div className="footer tw-mt-10 tw-bg-gray-300 tw-items-center">
            ...
            <hr />
            <div className="tw-mt-10 tw-bg-gray-300 tw-pb-5">
                <div className="tw-grid md:tw-grid-cols-2 tw-gap-4 tw-items-center">
                    <div className="text-center">
                        <p className="tw-font-semibold">
                            © 2020 E-BEE. POWERED BY <a href="https://beeonline.xyz/" className="tw-text-yellow-500 hover:tw-text-blue-900 tw-font-bold">BEE INC.</a>
                        </p>
                    </div>
