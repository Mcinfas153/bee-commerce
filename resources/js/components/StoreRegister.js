...
export default function StoreRegister() {
  return (
        <div className="register-my-store">
            <div className="tw-m-auto">
                <div className="xl:tw-w-4/12 lg:tw-w-6/12 md:tw-w-7/12 sm:tw-w-9/12 tw-w-11/12 tw-mt-10 tw-px-10 tw-py-5 tw-rounded-md tw-bg-white tw-mx-auto tw-mt-5">
                    ...
                    <p className='tw-text-md tw-font-light tw-text-center tw-text-yellow-300 tw-mb-4'>Regiter your store on bee to start your business.</p>
                    <form className="md:tw-my-5">
                        <div className="tw-mb-4">
                            <p className="tw-mb-2 tw-ml-2 tw-text-sm tw-font-semibold tw-text-gray-600">Display Name</p>
                        ...
                        <div className="tw-grid tw-grid-cols-12 tw-gap-2 sm:tw-gap-1 tw-mt-10 md:tw-mt-5 tw-items-center">
                            <div className="tw-col-span-12 sm:tw-mx-auto">
                            ...
                            <div className="tw-col-span-12 tw-mx-auto tw-mt-8">
                                <a href="/login-my-store" className="tw-underline tw-text-gray-600 hover:tw-text-yellow-500"><p>Already Have A Store?</p></a>
                            </div>
                            <div className="tw-col-span-12 tw-mx-auto">
                                <a href="/" className="tw-underline tw-text-gray-600 hover:tw-text-yellow-500"><p>Return to Home</p></a>
                            </div>
                        </div>
                    </form>
                </div>
