...
export default function TopNav() {
    return (
        <div className="tw-grid tw-grid-cols-12 tw-gap-1 tw-bg-white tw-px-5 tw-py-5">
            <div className="tw-col-span-full md:tw-col-span-2 tw-flex tw-justify-center md:tw-justify-start tw-items-center tw-gap-5">
                <img src="../images/logo.png" className="tw-w-10" />
                <span className="tw-text-center tw-uppercase tw-text-blue-900 tw-font-extrabold tw-text-3xl"><a className="text-blue-900">E</a>-<a className="text-yellow-500">BEE</a></span>
            </div>
            ...
            <div className="tw-col-span-full md:tw-col-span-3 tw-hidden md:tw-flex tw-justify-center md:tw-justify-end tw-items-center tw-gap-5 tw-mt-5 md:tw-mt-0">
                <span className="tw-cursor-pointer"><FontAwesomeIcon icon={faUser} /></span>
                <span className="tw-cursor-pointer"><FontAwesomeIcon icon={faHeart} /></span>
                <span className="tw-cursor-pointer"><FontAwesomeIcon icon={faSignal} /></span>
                <span className="tw-cursor-pointer"><FontAwesomeIcon icon={faShoppingCart} /></span>
            </div>
        </div>
    )
}
