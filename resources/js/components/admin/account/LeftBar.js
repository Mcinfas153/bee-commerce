...
export default function LeftBar() {
    return (
        <div className="LeftBar tw-my-10 tw-mx-5">
            <LeftBarItem className="tw-border tw-rounded-t-lg" SideBarItem="My Account" Image="https://img.icons8.com/flat-round/20/000000/positive-dynamic.png" Classes="LeftBarItem tw-border tw-border-opacity-100 tw-cursor-pointer hover:tw-bg-yellow-500 hover:tw-border-none tw-rounded-t-lg"/>
            <LeftBarItem SideBarItem="My Profile" Image="https://img.icons8.com/office/20/000000/user.png" Classes="LeftBarItem tw-border tw-border-opacity-100 tw-cursor-pointer hover:tw-bg-yellow-500 hover:tw-border-none"/>
